                    ...
                    <tr>
                        ...
                        <th scope="col"
                            ...
                            <button wire:click="sortable('respuesta')">
                                <span class="fa fa{{ $camp === 'respuesta' ? $icon : '-circle' }}"></span>
                            </button>
                        </th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-medium  uppercase tracking-wider">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @foreach ($informes as $informe)
                        <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">{{ $informe->respuesta }}</div>

                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span
                                    class="bg-red-200 text-red-600 py-1 px-3 rounded-full text-xs">{{ $informe->estado_cambiado }}</span>
                            </td>
